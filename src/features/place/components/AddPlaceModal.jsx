      ...
      >
        ...
        <div className="p-6 md:p-8 overflow-y-auto space-y-6 custom-scrollbar">
          ...
          >
            ...
            {/* Nhớ import thêm icon ở đầu file: import { LocateFixed } from "lucide-react"; */}
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center justify-between px-1">
                ...
                <button
                  type="button"
                  onClick={() => getGPSOfUser()}
                  className="flex items-center gap-1.5 text-xs font-semibold text-slate-500 hover:text-slate-900 transition-colors group focus-visible:outline-none"
                >
                  <LocateFixed
                    size={14}
              ...
              <div className="w-full h-[250px] md:h-[300px] mt-1 rounded-[1.5rem] overflow-hidden border border-slate-200 shadow-sm relative z-0">
                <MapPicker
