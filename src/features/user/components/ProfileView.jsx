          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-5 -mt-12 md:-mt-16 mb-6 md:mb-8">
            ...
            <div className="relative inline-block shrink-0">
              <img
                ...
                className="w-24 h-24 md:w-32 md:h-32 rounded-full object-cover border-4 border-white shadow-sm bg-white relative z-10"
              />
            </div>
            ...
            <div className="flex items-center gap-3 relative z-10">
              {isOwner ? (
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-6 py-2.5 bg-slate-900 text-white font-semibold text-sm rounded-full border border-slate-900 hover:bg-slate-800 cursor-pointer transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-900 focus-visible:ring-offset-2"
                >
                ...
                <>
                  <button className="px-6 py-2.5 bg-white text-slate-900 font-semibold text-sm rounded-full border border-slate-200 hover:bg-slate-50 transition-colors">
                    Liên hệ
                  </button>
                  <button className="px-6 py-2.5 bg-slate-900 text-white font-semibold text-sm rounded-full border border-slate-900 hover:bg-slate-800 transition-colors">
                    Theo dõi
                  </button>
                </>
              )}
